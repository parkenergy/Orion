...
var QuarterlyInventory = require();

before(function(done) {
  require('../../app.js');
  mongoose.connection.on('connected', function() {
    QuarterlyInventory.remove({}, done);
  });
});
...
describe("QuarterlyInventory", function() {
  ...
  describe("#updateDoc()", function() {
    ...
    it('should update document', function(done) {
      QuarterlyInventory.updateDoc(id, {})
        .then()
    });
  });
