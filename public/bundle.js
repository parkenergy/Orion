...
.directive('typeAhead', [function() {
  return {
    restrict: 'E',
    templateUrl: '/Common/public/angular/views/customElements/typeahead.html',
    scope: {
      labelText: '@',
      data: '=',
      selectField: '@',
...
['$scope', '$route', '$location', 'AlertService', 'LoaderService', 'engines',
  function ($scope, $route, $location, AlertService, LoaderService, engines) {
    ...
    $scope.superTableModel = {
  	...
  	function getObjectList () {
      var oList = [];
      engines.forEach(function (ele, arr, ind) {
        oList.push({
          _id: ele._id,
          serial: ele.serial,
          model: ele.model,
...
['$scope', '$route', '$location', 'AlertService', 'LoaderService', 'locations',
  function ($scope, $route, $location, AlertService, LoaderService, locations) {
    ...
    $scope.superTableModel = {
      ...
      locations.forEach(function (ele, arr, ind) {
        oList.push({
          _id: ele._id,
          name: ele.name,
...
.directive('workorderHeading', [function() {
  return {
    restrict: 'E',
    templateUrl: '/Common/public/angular/apps/workorder/views/edit/header/woHeading.html',
    scope: true
  };
}]);
...
.directive('workorderEngineCompression', [function() {
  return {
    restrict: 'E',
    templateUrl: '/Common/public/angular/apps/workorder/views/edit/pm/woEngineCompression.html',
    scope: true
  };
}]);
