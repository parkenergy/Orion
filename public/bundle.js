...
['$scope', '$route', '$location', '$q', 'AlertService', 'LoaderService', 'WorkOrders', 'me',
  function ($scope, $route, $location, $q, AlertService, LoaderService, WorkOrders, me) {

    $scope.title = "My Account";
    $scope.me = me.username;
    $scope.spinner = true;
