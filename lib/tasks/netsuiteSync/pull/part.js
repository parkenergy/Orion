...
const partSearchUrl1 = {
    url:
        "https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=248&deploy=1&recordtype=item&id=90",
    id: 90,
};
...
const formatPart = (part) => {
    return {
        ...
        description: part.description.trim().replace(/[\n\r]/g, '').replace(/  +/g, ' '),
