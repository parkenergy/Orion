...
const partSearchUrl10 = {
    url: 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=311',
    id:  311,
}
const partSearchUrl11 = {
    url: 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=318',
    id:  318,
}
const partSearchUrl12 = {
    url: 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=319',
    id:  319,
}
const partSearchUrl13 = {
    url: 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=320',
    id:  320,
}

const urls = [partSearchUrl1, partSearchUrl2, partSearchUrl3, partSearchUrl4, partSearchUrl5, partSearchUrl6,
    partSearchUrl7, partSearchUrl8, partSearchUrl9, partSearchUrl10, partSearchUrl11, partSearchUrl12, partSearchUrl13]
...
const setNotSyncedToInactive = () => {
    return new Promise((resolve, reject) => {
        Part.update({isSynced: false}, {activeStatus: true}, {multi: true},
            (err) => {
                if (err) return reject(err);
                resolve();
            });
