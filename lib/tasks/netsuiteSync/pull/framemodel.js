...
const frameModelListUrl =
    "https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=92&deploy=1&listid=customlist_frame_model";
    ...
    return new Promise((resolve, reject) => {
        ...
        queryFrameModels()
            ...
            .then((frameModels) => {
                ...
                FormattedFrameModels = frameModels.map((u) =>
                    formatFrameModel(u)
                );
