...
const engineModelListUrl =
    "https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=92&deploy=1&listid=customlist_eng_model";
    ...
    return new Promise((resolve, reject) => {
        ...
        queryEngineModels()
            ...
            .then((engineModels) => {
                ...
                FormattedEngineModels = engineModels.map((u) =>
                    formatEngineModel(u)
                );
