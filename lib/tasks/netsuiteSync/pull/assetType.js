...
const assettypeListUrl =
    "https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=92&deploy=1&listid=customlist_comptype";
        ...
        assetTypes.forEach((assetType) => {
            ...
            docs.forEach((doc) => {
                if (doc.netsuiteId === assetType.netsuiteId) {
                    found = true;
                    changes.push({
                        diff: diff(assetType, doc),
                        old: assetType.netsuiteId,
