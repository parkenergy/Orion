...
const applicationTypeListUrl =
    "https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=92&deploy=1&listid=customlist_applicationtype";
    ...
    return new Promise((resolve, reject) => {
        ...
        queryApplicationTypes()
            ...
            .then((applicationTypes) => {
                ...
                FormattedApplicationTypes = applicationTypes.map((u) =>
                    formatApplicationType(u)
                );
