...
const formatUnit = (unit) => {
    return {
        ...
        frameModel:       unit.frameModel ? unit.frameModel : null,
        engineModel:      unit.engineModel ? unit.engineModel : null,
...
async function getAsyncUnitInfo(engine, frame, county, state, nsUserId) {
    ...
    return {engineNSID, frameNSID, countyObjID, stateObjID, username}
}
            ...
            .then((res) => {
                resolve({
                    ...
                    nextPM5Date: ele.columns.hasOwnProperty('custrecord_next_pm5_date')
                        ...
                        : null,
                    frameModel: res.frameNSID ? res.frameNSID.toUpperCase() : '',
                    engineModel: res.engineNSID ? res.engineNSID.toUpperCase() : '',
                })
            })
            .catch(reject)
    });
