...
const userSearchUrl =
    "https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=248&deploy=1&recordtype=employee&id=97";
...
const userFormat = (ele) => {
    return {
        ...
        username: ele.columns.custentity_techid,
        email:
            ele.columns.email === ""
                ? null
                : ele.columns.email
        ...
        role: ele.columns.custentity_orion_administrator
            ? "admin"
            : ele.columns.custentity_field_service_manager
            ? "manager"
            : "tech",
        area: ele.columns.hasOwnProperty("class") ? ele.columns.class.name : "",
        areaId: ele.columns.hasOwnProperty("class")
            ? ele.columns.class.internalid
            : "",
        location: ele.columns.location
            ? ele.columns.location.name
                ? ele.columns.location.name
                : ""
            : "",
        netsuiteId: ele.id,
