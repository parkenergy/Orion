...
const unitFormat = (ele) => {
    return new Promise((resolve, reject) => {
        ...
        if (ele.columns.hasOwnProperty('custrecord_asset_customer')) {
            if (ele.columns.custrecord_asset_customer.name) {
                customerName = ele.columns.custrecord_asset_customer.name
            }
        }
