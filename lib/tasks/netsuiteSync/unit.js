                ...
                County.findOne({name: county, state: state}, function (err, countyObj) {
                    ...
                    resolve({
                        ...
                        nextPM5Date:      ele.columns.hasOwnProperty('custrecord_next_pm5_date')
                                              ...
                                              : null,
                        frameModel:       ele.columns.hasOwnProperty('custrecord_framemodel')
                                              ? ele.columns.custrecord_framemodel
                                              : null,
                        engineModel:      ele.columns.hasOwnProperty('custrecord_engine_model')
                                              ? ele.columns.custrecord_engine_model
                                              : null,
                    });
                });
            });
