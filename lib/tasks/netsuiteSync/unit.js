...
function unitFormat (ele, callback) {
  ...
  var unit = {
    ...
    engineSerial: ele.columns.custrecord_engine_serial_asset_level,
    compressorSerial: ele.columns.custrecord_compressor_serial_asset_level,
    
    assignedTo: ele.columns.hasOwnProperty("custrecord_assignedtech") ? ele.columns.custrecord_assignedtech.name : "",
