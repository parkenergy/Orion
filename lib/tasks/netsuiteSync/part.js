...
const partSearchUrl2 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=295'
const partSearchUrl3 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=219'
const partSearchUrl4 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=296'
const partSearchUrl5 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=297'
const partSearchUrl6 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=298'
const partSearchUrl7 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=299'
const partSearchUrl8 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=300'
const partSearchUrl9 = 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=91&deploy=1&recordtype=item&id=301'

const urls = [partSearchUrl1, partSearchUrl2, partSearchUrl3, partSearchUrl4, partSearchUrl5, partSearchUrl6, partSearchUrl7, partSearchUrl8, partSearchUrl9]
const options = {
    headers: {
...
module.exports = function () {
    return new Promise((resolve, reject) => {
        ...
        Promise.all(promises)
               ...
               /*queryParts(partSearchUrl1, options)
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl2, options)
                   })
                   .then((parts) => {
                      allParts.concat(parts)
                       return queryParts(partSearchUrl3, options)
                   })
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl4, options)
                   })
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl5, options)
                   })
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl6, options)
                   })
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl7, options)
                   })
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl8, options)
                   })
                   .then((parts) => {
                       allParts.concat(parts)
                       return queryParts(partSearchUrl9, options)
                   })*/
               .then(() => Part.find({}).exec())
               .then((parts) => {
