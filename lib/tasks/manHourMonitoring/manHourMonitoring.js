...
const renderTableRow = (obj, array) => {
    return array.map((item) => {
      ...
      <tr id="${item}">
        <td>${item}</td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v1Search/${obj.weekStart}/${obj.user.username}/${type}">
    ...
    <table width="40%" border="1" cellpadding="10" cellspacing="0">
      ...
      <tr>
        ...
        <td style="background-color: #ccc">
          <a href="http://orion.parkenergyservices.com/#/workorder/v1Search/${techObj.weekStart}/${techObj.user.username}">${techObj.total.toFixed(2)}</a>
        </td>
      </tr>
    </table>
  `;
