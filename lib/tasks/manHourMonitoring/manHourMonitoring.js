    ...
    WorkOrder.find({
      ...
      .then((objArr) => {
        if (objArr.length === 1) {
          ...
          resolve({user, times, Indirect: objArr[0].Indirect.hours, PM: objArr[0].PM.hours, Corrective: objArr[0].Corrective.hours, TroubleCall: objArr[0].TroubleCall.hours, NewSet: objArr[0].NewSet.hours, Transfer: objArr[0].Transfer, Swap: objArr[0].Swap, Release: objArr[0].Release.hours, Travel: objArr[0].Travel.hours});
        } else {
