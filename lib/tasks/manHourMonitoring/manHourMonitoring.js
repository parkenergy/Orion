 ...
 */
const tableArray = ['PM', 'Corrective', 'TroubleCall', 'Indirect', 'Travel', 'NewSet', 'Release'];
  ...
  return new Promise((resolve, reject) => {
    ...
    TH.getUsers()
      .then((users) => {
        ...
        const times = TH.getToFromDates(6, false);
      ...
      .then((objArr) => {
        ...
        objArr.forEach((obj) => {
          ...
          const total = obj.Indirect + obj.PM + obj.Corrective + obj.TroubleCall + obj.NewSet + obj.Release + obj.Travel;
          // if (total >= 15) {
          if (total >= 45) {
