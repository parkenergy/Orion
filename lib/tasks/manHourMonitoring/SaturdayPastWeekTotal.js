...
const renderTableRow = (tech, SuperObjManagerTECHS, TimeObj) => {
    if (TimeObj) {
      ...
      <tr  id="${tech}">
        ...
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Saturday.times.returnStart}/${TimeObj.Saturday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Saturday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Sunday.times.returnStart}/${TimeObj.Sunday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Sunday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Monday.times.returnStart}/${TimeObj.Monday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Monday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Tuesday.times.returnStart}/${TimeObj.Tuesday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Tuesday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Wednesday.times.returnStart}/${TimeObj.Wednesday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Wednesday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Thursday.times.returnStart}/${TimeObj.Thursday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Thursday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Friday.times.returnStart}/${TimeObj.Friday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ${SuperObjManagerTECHS[tech].Friday.toFixed(2)}
          </a>
        </td>
        <td>
          <a href="http://orion.parkenergyservices.com/#/workorder/v2Search/${TimeObj.Saturday.times.returnStart}/${TimeObj.Friday.times.returnEnd}/${SuperObjManagerTECHS[tech].tech.username}">
            ...
            if (user.email) {
                ...
                mailer.transport.verify((err) => {
                    if (err) {
                        ...
                        const to = process.env.NODE_ENV === undefined
                            ? 'mwhelan@parkenergyservices.com'
                            : user.email;
                        const mailerOptions = {
