...
const renderTableRow = (tech, SuperObjManagerTECHS, TimeObj) => {
    if (TimeObj) {
        const SaturdayTimeStart = JSON.stringify(TimeObj.Saturday.times.returnStart)
        const SaturdayTimeEnd = JSON.stringify(TimeObj.Saturday.times.returnEnd)
        const SundayTimeStart = JSON.stringify(TimeObj.Sunday.times.returnStart)
        const SundayTimeEnd = JSON.stringify(TimeObj.Sunday.times.returnEnd)
        const MondayTimeStart = JSON.stringify(TimeObj.Monday.times.returnStart)
        const MondayTimeEnd = JSON.stringify(TimeObj.Monday.times.returnEnd)
        const TuesdayTimeStart = JSON.stringify(TimeObj.Tuesday.times.returnStart)
        const TuesdayTimeEnd = JSON.stringify(TimeObj.Tuesday.times.returnEnd)
        const WednesdayTimeStart = JSON.stringify(TimeObj.Wednesday.times.returnStart)
        const WednesdayTimeEnd = JSON.stringify(TimeObj.Wednesday.times.returnEnd)
        const ThursdayTimeStart = JSON.stringify(TimeObj.Thursday.times.returnStart)
        const ThursdayTimeEnd = JSON.stringify(TimeObj.Thursday.times.returnEnd)
        const FridayTimeStart = JSON.stringify(TimeObj.Friday.times.returnStart)
        const FridayTimeEnd = JSON.stringify(TimeObj.Friday.times.returnEnd)
