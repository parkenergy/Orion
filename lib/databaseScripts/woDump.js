            ...
            cursor
                ...
                .then(() => {
                    ...
                    return docs.reduce((csv, row) => {
                        ...
                        //   Adding missing Labor codes rransom 3.14.2022
	const serviceTravel =
...
const catalystReplace = 
                            row.laborCodes.emissionsReadings.catalystReplace.hours +
                                                        row.laborCodes.emissionsReadings.catalystReplace.minutes / 60;

const emissionsThermocoupling = 
                            row.laborCodes.emissionsReadings.emissionsThermocoupling.hours +
                                               row.laborCodes.emissionsReadings.emissionsThermocoupling.minutes / 60;

const exhaustGasketReplace = 
                            row.laborCodes.emissionsReadings.harnessRepair.hours +
                                                        row.laborCodes.emissionsReadings.harnessRepair.minutes / 60;
const o2SensorReplace= 
                            row.laborCodes.emissionsReadings.o2SensorReplace.hours +
                                                        row.laborCodes.emissionsReadings.o2SensorReplace.minutes / 60;

const facilitySetup= 
                            row.laborCodes.emissionsReadings.facilitySetup.hours +
                                                        row.laborCodes.emissionsReadings.facilitySetup.minutes / 60;

const adjustment= 
                            row.laborCodes.emissionsReadings.adjustment.hours +
                                                        row.laborCodes.emissionsReadings.adjustment.minutes / 60;

const troubleshooting= 
                            row.laborCodes.emissionsReadings.troubleshooting.hours +
                                                        row.laborCodes.emissionsReadings.troubleshooting.minutes / 60;

const standBy= 
                            row.laborCodes.emissionsReadings.standBy.hours +
                                                        row.laborCodes.emissionsReadings.standBy.minutes / 60;

const analyzerRepair= 
                            row.laborCodes.emissionsReadings.analyzerRepair.hours +
                                                        row.laborCodes.emissionsReadings.analyzerRepair.minutes / 60;

const calibration= 
                            row.laborCodes.emissionsReadings.calibration.hours +
                                                        row.laborCodes.emissionsReadings.calibration.minutes / 60;

const reportGeneration= 
                            row.laborCodes.emissionsReadings.reportGeneration.hours +
                                                        row.laborCodes.emissionsReadings.reportGeneration.minutes / 60;
