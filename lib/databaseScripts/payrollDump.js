    ...
    return new Promise((resolve, reject) => {
        ...
        cursor
            ...
            .then(docs => {
                ...
                }, "TimeStarted.UTC,TimeSubmitted.UTC,TimeStarted.Actual,TimeSubmitted.Actual,TechId,TruckId,Total Hours Decimal,Type,AtShop,Header.unitNumber,Header.customer,Header.county,Header.state,Header.lease,Comments.indirectNotes\n");
            })
            .then(r => {
                resolve(r);
            })
