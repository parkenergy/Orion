    ...
    return new Promise((resolve, reject) => {
        ...
        cursor
            ...
            .then(docs => {
                ...
                }, "TimeStarted.UTC,TimeSubmitted.UTC,TechId,TruckId,Total Hours Decimal,Type,AtShop,Header.unitNumber,Header.customer,Header.county,Header.state,Header.lease,Comments.indirectNotes"+query+"\n");
            })
            .then(r => {
                resolve(r);
            })
