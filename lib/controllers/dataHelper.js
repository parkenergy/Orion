...
var DataHelper = function (collection) {
  ...
  return {
    ...
    create: function (req, callback) {
      ...
      //cast dates
      if(req.body.timeStarted) req.body.timeStarted = new Date(req.body.timeStarted);
      if(req.body.timeSubmitted) req.body.timeSubmitted = new Date(req.body.timeSubmitted);
      if(req.body.timeApproved) req.body.timeApproved = new Date(req.body.timeApproved);
