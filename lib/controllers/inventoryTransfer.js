...
InventoryTransferCtrl.create = (req, res) => {
    ...
    InventoryTransfer.createDoc(req.body).then(res.resolve).catch(res.reject);
};
...
InventoryTransferCtrl.list = (req, res) => {
    ...
    InventoryTransfer.list(options).then(res.resolve).catch(res.reject);
};
...
InventoryTransferCtrl.read = (req, res) => {
    ...
    InventoryTransfer.fetch(id).then(res.resolve).catch(res.reject);
};
...
InventoryTransferCtrl.update = (req, res) => {
    ...
    InventoryTransfer.updateDoc(id, body).then(res.resolve).catch(res.reject);
};
...
InventoryTransferCtrl.delete = (req, res) => {
    ...
    InventoryTransfer.delete(id).then(res.resolve).catch(res.reject);
};
