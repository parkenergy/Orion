...
module.exports = function (countySchema) {
    ...
    //Create Document/s
    countySchema.statics.createDoc = function (data) {
    ...
    countySchema.statics.updateDoc = function (id, data) {
    ...
    //fetch by _id
    countySchema.statics.fetch = function (id) {
    ...
    countySchema.statics.sync = function (options) {
        return new Promise((resolve, reject) => {
            const q = {};
            if (options.id) {
                q.id = {
    ...
    //list documents
    countySchema.statics.list = function (options) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if ((options.skip !== null || options.skip !== undefined) &&
                ...
                cursor
                    .skip(options.skip * options.limit).limit(options.limit);
            }
    ...
    //Delete document
    countySchema.statics.delete = function (id) {
    ...
    countySchema.methods.getCreateDate = function () {
