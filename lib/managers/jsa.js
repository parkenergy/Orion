...
module.exports = function(jsaSchema) {

  /*** MODEL METHODS ***/

  //Create Document/s
  jsaSchema.statics.createDoc = function(data) {
    var self = this;
  ...
  jsaSchema.statics.updateDoc = function(id, data) {
    var me = this;
    return new Promise(function(resolve, reject) {
  ...
  //fetch by _id
  jsaSchema.statics.fetch = function(id) {
    var self = this;
  ...
  //list documents
  jsaSchema.statics.list = function(options) {
    var self = this;
  ...
  //Delete document
  jsaSchema.statics.delete = function(id) {
    var self = this;
  ...
  jsaSchema.methods.getCreateDate = function() {
