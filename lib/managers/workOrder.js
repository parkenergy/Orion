...
module.exports = function (workOrderSchema) {
      ...
      Promise.join(
        ...
        Unit.find({
          _id: {
            ...
            $in: dataArr.map((obj) => {
              if (Object.prototype.toString.call(obj.unit) === '[object String]') {
                return ObjectId(obj.unit);
              } else if (Object.prototype.toString.call(obj.unit) === '[object Object]') {
                return obj.unit;
              } else {
                return obj.unit;
              }
  ...
  workOrderSchema.statics.approveAndUpdate = function (id, doc, identity) {
    ...
    /*mailer.transport.set('oauth2_provision_cb', (user, renew, callback) => {
      console.log(user);
      console.log(renew);
    ...
    let mailOptions = {
      from: '"Marcus Whelan" <mwhelan@parkenergyservices.com>',
