                        ...
                        workorders.forEach((wo) => {
                            if ((new Date(wo.timeSubmitted).getTime() <
                                ...
                                let mailOptions = {
                                    ...
                                    html:    `
                  <body>
                      <a href="http://orion.parkenergyservices.com/#/workorder/view/${wo._id}">Link to Work Order</a>
                      <br>
                  </body>
                  `,
                                };
                ...
                mailer.transport.verify(function (error, success) {
                    if (error) {
                        ...
                        let mailOptions = {
                            ...
                            html:    `
            <body>
                <a href="http://orion.parkenergyservices.com/#/workorder/view/${wos._id}">Link to Work Order</a>
                <br>
            </body>
            `,
                        };
