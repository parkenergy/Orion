        ...
        Unit.find({
          netsuiteId: {
            ...
            $in: dataArr.map((obj) => {
              ...
              if (obj.hasOwnProperty("unit") && obj.unit.hasOwnProperty("netsuiteId")) {
                ...
                /*if (typeof obj.unit === 'string' && obj.unit.length === 24) {
                  ...
                  if (obj.unit.hasOwnProperty("id") && obj.unit.id.length === 24) {
                    ...
                    return obj.unit.id;
                  } else if (obj.unit.hasOwnProperty("_id") && obj.unit._id.length === 24) {
                    console.log(2);
                    console.log(obj.unit._id.length);
                    obj.unit._id = ObjectId(obj.unit._id);
                    return obj.unit._id;
          ...
          const unit = _.find(unitDocs, (o) => {
            ...
            if (doc.hasOwnProperty('unit')) {
              ...
              if (typeof doc.unit === 'object') {
                ...
                } else if (doc.unit.hasOwnProperty('_id')) {
                  console.log(typeof doc.unit._id);
                  console.log(doc.unit._id.length);
                  console.log(typeof doc.unit._id.toString());
                  console.log(doc.unit._id.toString().length);
                  if (typeof doc.unit._id === 'string' && doc.unit._id.length === 24) {
                    console.log(4)
                    console.log(o._id.toString() === doc.unit._id);
                    console.log(o._id.toString() === doc.unit._id.toString())
                    console.log(o._id.toString() === ObjectId(doc.unit._id))
                    console.log(o._id.toString() === ObjectId(doc.unit._id).toString());
                    console.log(o._id === ObjectId(doc.unit._id))
                    console.log(o._id === doc.unit._id);
                    console.log(o._id === ObjectId(doc.unit._id).toString());
                    console.log(o._id);
                    console.log(doc.unit._id);
                    return o._id.toString() === ObjectId(doc.unit._id).toString();
    
                    // else the doc.unit.id is an ObjectId
                  } else if (typeof doc.unit._id === 'object') {
                    console.log(5);
                    // if the unit._id is a string
                    return o._id.toString() === doc.unit.id.toString();
                  }
          ...
          if (unit) {
            ...
            if (doc.type !== "Indirect" && !billable) {
              if (compareWorkorderUnitToUnit(getWorkOrderUnitInfo(doc), unit)) {
                ...
                promises.push(AutoSyncToNetsuite(doc));
              } else {
