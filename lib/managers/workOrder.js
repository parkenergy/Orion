    ...
    return new Promise(function (resolve, reject) {
      ...
      self.findById(id)
        ...
        .filter(function(edit){
          if((edit.path.length === 0) || (edit.path[0] === 'timePosted') || (edit.path[0] === "comments") || (edit.path[0] === "unit") || (edit.editType === "Add") || (edit.path[3] === "highlight") || (edit.path[0] === "timeApproved") (edit.path[0] === "unitNumber")){
            return false;
          }else{
            return true;
          }
