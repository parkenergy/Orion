    ...
    return new Promise((resolve, reject) => {
        ...
        populateCustomerByName(doc)
            .then((wo) => {
                ...
                let BASE_URL = 'https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl'
                ...
                let completeData = HTTP_METHOD + '&' + encodeURIComponent(BASE_URL) + '&' +
                    encodedData
                let hmacsha1Data = CryptoJS.HmacSHA1(completeData, CONSUMER_SECRET + '&' +
                    TOKEN_SECRET)
                ...
                const oauth = OAuth({
                    consumer: {
                        key: '747d3d1d175c4e866938e8712b90e420606981c5e389acb140c74eec5cfb6674',
                        secret: '38b57c0910b0b920f2f8ba1c2d0d4781418937be6cf2bfc9ee5b3c8532b58a37'
                    },
                ...
                const token = {
                    key: '91a98fb2380a49f47700e2f88112935af7cc5081aa8f72d8bf5e5f2df49d72cb',
                    secret: 'e6d9706fef2a5f270f947b49ccaaca213aae5513d6077681db57ffa23a2e6307'
                }
                const request_data = {
                    url: 'https://4086435.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=112&deploy=1',
                    method: 'POST',
                };
                // data: nswo,
                // realm:'4086435'
