    ...
    return new Promise(function (resolve, reject) {
      ...
      self.findById(id)
        ...
        .filter(function(edit){
          return (edit.before === null && edit.after === null) || edit.path[0] !== "parts" || (edit.path.length === 0) || (edit.path[0] === "laborCodes" && edit.after === true) || (edit.path[0] === 'timePosted') || (edit.path[0] === "comments") || (edit.path[0] === "unit");
        })
        .then(function (docs) {
