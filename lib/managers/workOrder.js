...
module.exports = function (workOrderSchema) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      self.findById(id)
        ...
        .filter(function(edit){
          return ((edit.path.length !== 0) || (edit.path[0] !== 'timePosted') || (edit.path[0] !== "comments") || (edit.path[0] !== "unit") || (edit.editType !== "Add") || (edit.path[3] !== "highlight") || (edit.path[0] !== "managerApproved") (edit.path[0] !== "unitNumber"));
        })
        .then(function (docs) {
  ...
  workOrderSchema.statics.managerApprove = function (id, identity) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      self.findByIdAndUpdate(id, {$set: {approvedBy: identity.username, timeApproved: new Date()}})
        .then(resolve)
        .catch(reject);
    });
  };
