              ...
              if (obj.hasOwnProperty("unit")) {
                if (typeof obj.unit === 'string' && obj.unit.length === 24) {
                  ...
                  if (obj.unit.hasOwnProperty("id") && obj.unit.id.length === 24) {
                    ...
                    return obj.unit.id;
                  } else if (obj.unit.hasOwnProperty("_id")) {
                    console.log(2);
                    console.log(typeof obj.unit._id);
                    console.log(obj.unit._id);
                    console.log(typeof obj.unit._id.toString());
                    console.log(obj.unit._id.toString().length);
                    return obj.unit._id;
