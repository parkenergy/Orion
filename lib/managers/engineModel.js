...
module.exports = function (engineModelSchema) {

    /*** MODEL METHODS ***/

    //Create Document/s
    engineModelSchema.statics.createDoc = function (data) {
    ...
    engineModelSchema.statics.updateDoc = function (id, data) {
        return new Promise((resolve, reject) => {
    ...
    //fetch by _id
    engineModelSchema.statics.fetch = function (id) {
        return new Promise((resolve, reject) => {
            if (typeof id === 'string') id = ObjectId(id)
    ...
    engineModelSchema.statics.sync = function (options) {
        return new Promise((resolve, reject) => {
            const q = {}
    ...
    //list documents
    engineModelSchema.statics.list = function (options) {
        return new Promise((resolve, reject) => {
            //query object
            const q = {}
    ...
    //Delete document
    engineModelSchema.statics.delete = function (id) {
        return new Promise((resolve, reject) => {
            if (typeof id === 'string') id = ObjectId(id)
