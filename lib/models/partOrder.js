...
partOrderSchema.pre('findOneAndUpdate', function (next) {
  this._update.timeShipped = ( (this._update.status === 'shipped') && !this._update.timeShipped ) ? new Date() : null;
  this._update.timeComplete = ( (this._update.status === 'completed') && !this._update.timeComplete ) ? new Date() : null;
