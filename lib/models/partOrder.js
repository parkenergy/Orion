...
var partOrderSchema = new mongoose.Schema({
  ...
  approvedBy: { type: String, index: true }, // Manager/Admin.
  // !!!!! NEED TO CHANGE THIS ON THE CLIENT FROM MANAGERID TO THIS!!!!
  originNSID: {type: String}, // origin NSID set by manager
  destinationNSID: {type: String, require: true}, // destination NSID set by technician
