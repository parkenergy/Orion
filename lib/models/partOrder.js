...
partOrderSchema.pre('update', updateTimeStamps);
...
partOrderSchema.pre('findOneAndUpdate', function (next) {
  log.warn({thisIs: this}, "FINDONEANDUPDATE");
...
partOrderSchema.pre('update', function (next) {
  log.warn({thisIs: this}, "UPDATE");
  /*if(this._update.$set.status === 'canceled' && this._update.$set.completedBy){
    this._update.$set.done = true;
  }*/
