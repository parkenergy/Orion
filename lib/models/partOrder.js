...
//stamp updated_at on findOneAndUpdate
partOrderSchema.pre('findOneAndUpdate', updated_at);
...
partOrderSchema.pre('findOneAndUpdate', updateTimeStamps);
...
//set done on findOneAndUpdate
partOrderSchema.pre('findOneAndUpdate', setDone);
