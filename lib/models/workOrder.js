...
const workOrderSchema = new mongoose.Schema({
    ...
    unitReadings: {
        displayEngineModel: {type: String},
        displayFrameModel:  {type: String},
        // Engine
        engineModel:        {type: String}, // 1
        engineSerial:       {type: String}, // 2       *
        engBattery:         {type: String}, // 3
        engOilTemp:         {type: String}, // 4 guage
        engOilTempKill:     {type: String}, // 5
        engineJWTemp:       {type: String}, // 6 guage *
        engineJWTempKill:   {type: String}, // 7
        engineOilPressure:  {type: String}, // 8 guage *
        engOilPressureKill: {type: String}, // 9
        alternatorOutput:      {type: String}, // 10 guage *
        hourReading:           {type: String}, // 12 guage *
        engAirInletTemp:       {type: String}, // 14 guage
        engAirInletTempKill:   {type: String}, // 15
        engJWPress:            {type: String}, // 16 guage
        engJWPressKill:        {type: String}, // 17
        engTurboExhTempR:      {type: String}, // 18 guage
        engTurboExhTempRKill:  {type: String}, // 19
        engTurboExhTempL:      {type: String}, // 20 guage
        engTurboExhTempLKill:  {type: String}, // 21
        rpm:                   {type: String}, // 24 guage *
        engIgnitionTiming:     {type: String}, // 27 guage
        engVacuumBoostR:       {type: String}, // 28 guage
        engVacuumBoostRKill:   {type: String}, // 29
        engVacuumBoostL:       {type: String}, // 30 guage
        engVacuumBoostLKill:   {type: String}, // 31
        engManifoldTempR:      {type: String}, // 32 guage
        engManifoldTempRKill:  {type: String}, // 33
        engManifoldTempL:      {type: String}, // 34 guage
        engManifoldTempLKill:  {type: String}, // 35
        engineManifoldVac:     {type: String}, // 36     *
        // Compressor
        compressorModel:       {type: String}, // 100
        compressorSerial:      {type: String}, // 59     *
        suctionPressure:       {type: String}, // 60 guage * kills in kill settings pm checklist
        // listed # stage pressure
        compInterPress1:       {type: String}, // 63 guage
        compInterPress1Low:    {type: String}, // 64 Kill
        compInterPress1High:   {type: String}, // 65 kill
        compInterPress2:       {type: String}, // 66 guage
        compInterPress2Low:    {type: String}, // 67 kill
        compInterPress2High:   {type: String}, // 68 kill
        compInterPress3:       {type: String}, // 69 guage
        compInterPress3Low:    {type: String}, // 70 kill
        compInterPress3High:   {type: String}, // 71 kill
        dischargePressure:     {type: String}, // 72 final * kills in kill settings pm checklist
        dischargeTemp1:        {type: String}, // 77 guage * is now Left
        dischargeTemp2:        {type: String}, // 79 guage * is now Right
        dischargeStg1Temp:     {type: String},
        dischargeStg1TempKill: {type: String},
        dischargeStg2Temp:     {type: String},
        dischargeStg2TempKill: {type: String},
        dischargeStg3Temp:     {type: String},
        dischargeStg3TempKill: {type: String},
        dischargeStg4Temp:     {type: String},
        dischargeStg4TempKill: {type: String},
        dischargeTemp4Kill:    {type: String}, // 84
        compressorOilPressure: {type: String}, // 89 guage *
        compOilPressKill:      {type: String}, // 90
        compOilTemp:           {type: String}, // 91 guage
        compOilTempKill:       {type: String}, // 92
        compDiffPCFilter:      {type: String}, // 97 guage
        compDiffPCFilterKill:  {type: String}, // 98
        flowMCF:               {type: String}, // 99 guage *
    },

    emissionsReadings: {
        afrmvTarget:             {type: String},    // 37 *
        catalystTempPre:         {type: String},    // 38 *
        catalystTempPreCatKill:  {type: String}, // 39
        catalystTempPost:        {type: String},    // 40 *
        catalystTempPostCatKill: {type: String}, // 41
        permitNumber:            {type: String},    // 42 *
        afrMake:                 {type: String},    // 43
        afrModel:                {type: String},    // 44
        afrSN:                   {type: String},    // 45
        EICSCPUSoftware:         {type: String},    // 46
        EICSDisplaySoftware:     {type: String},    // 47
        catalystHousingSN:       {type: String},    // 48
        catalystHousingMake:     {type: String},    // 49
        catalystHousingModel:    {type: String},    // 50
        catalystElementMake:     {type: String},    // 51
        catalystElementSN1:      {type: String},    // 52
        catalystElementSN2:      {type: String},    // 53
        o2Sensors:               {type: String},    // 54
        NOxSensor:               {type: String},    // 55
        testPInchesH2O:          {type: String},    // 57
    },
    ...
    pmChecklist: {
        ...
        fuelPressureThirdCut:  {type: String}, // new
        ...
        engineCompression:     {
            ...
            cylinder9:  {type: String},
            cylinder10: {type: String},
            cylinder11: {type: String},
            cylinder12: {type: String},
            cylinder13: {type: String},
            cylinder14: {type: String},
            cylinder15: {type: String},
            cylinder16: {type: String},
        }
    },
