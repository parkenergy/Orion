...
const workOrderSchema = new mongoose.Schema({
  ...
  pm:    { type: Boolean },
  type: { type: String, enum: ['PM', 'Trouble Call', 'New Set', 'Release', 'Indirect', 'Corrective'] },
...
workOrderSchema.virtual('longitude')
  .get(function () {
    return this.geo.coordinates[0];
  })
  .set(function (v) {
    this.geo.coordinates[0] = v;
  });

workOrderSchema.virtual('latitude')
  .get(function () {
    return this.geo.coordinates[1];
  })
  .set(function (v) {
    this.geo.coordinates[1] = v;
  });
