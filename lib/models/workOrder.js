...
const workOrderSchema = new mongoose.Schema({
    ...
    header: {
        ...
        timeOfCallout: { type: Number },
        killCode: { type: Number },
        county: { type: String },
        state: { type: String },
    ...
    unitReadings: {
        ...
        lubeRate: { type: String, default: "" }, // 99
        flowMCF: { type: String, default: "" }, // 99 guage * -> 100
    },
    ...
    emissionsReadings: {
        ...
        noSpotCheck: { type: Boolean, default: false },
        lastCalibration: { type: Number },
        NOxGrams: { type: String, default: "" },
        COGrams: { type: String, default: "" },
        NOxAllowable: { type: String, default: "" },
        COAllowable: { type: String, default: "" },
        /* - 1 -  */
    },
...
workOrderSchema.virtual("created_at").get(function () {
    return this.getCreateDate();
});

//Ensure order type is normalized
workOrderSchema.virtual("orderType").get(function () {
    if ((!this.type || this.type === "") && this.pm) {
        return "pm";
    }
    return this.type;
...
workOrderSchema.virtual("isPartBillable").get(function () {
...
workOrderSchema.virtual("totalWoTime").get(function () {
    let totalMin = 0;
