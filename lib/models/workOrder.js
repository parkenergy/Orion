...
const workOrderSchema = new mongoose.Schema({
  ...
  pm:    { type: Boolean },
  type: { type: String, enum: ['PM', 'Trouble Call', 'New Set', 'Swap', 'Transfer', 'Release', 'Indirect', 'Corrective'] },
  ...
  laborCodes: {
    ...
    engine: {
      ...
      coolingSystem:  { hours: { type: Number, default:0 }, minutes: { type: Number, default:0 }, text: {type: String} },
...
workOrderSchema.index({geo: '2dsphere'});
