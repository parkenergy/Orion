...
const workOrderSchema = new mongoose.Schema({
    ...
    unitReadings: {
        ...
        alternatorOutputKill:  {type: String}, // 11
        hourReading:           {type: String}, // 12 guage *
        engHourReadingKill:    {type: String}, // 13
        ...
        engOilHours:           {type: String}, // 22 guage
        engOilHoursKill:       {type: String}, // 23
        rpm:                   {type: String}, // 24 guage *
        rpmKill:               {type: String}, // 25
        engFuelPress:          {type: String}, // 26 guage
        ...
        suctionPressure:       {type: String}, // 60 guage *
        compSuctionPressLow:   {type: String}, // 61
        compSuctionPressHigh:  {type: String}, // 62
        compInterPress1:       {type: String}, // 63 guage
        compInterPress1Low:    {type: String}, // 64
        compInterPress1High:   {type: String}, // 65
        compInterPress2:       {type: String}, // 66 guage
        compInterPress2Low:    {type: String}, // 67
        compInterPress2High:   {type: String}, // 68
        compInterPress3:       {type: String}, // 69 guage
        compInterPress3Low:    {type: String}, // 70
        compInterPress3High:   {type: String}, // 71
        dischargePressure:     {type: String}, // 72 final *
        dischargePressureLow:  {type: String}, // 73
        dischargePressureHigh: {type: String}, // 74
        dischargeTemp1:        {type: String}, // 77 guage *
        dischargeTemp1Kill:    {type: String}, // 78
        dischargeTemp2:        {type: String}, // 79 guage *
        dischargeTemp2Kill:    {type: String}, // 80
        dischargeTemp3:        {type: String}, // 81 guage
        dischargeTemp3Kill:    {type: String}, // 82
        dischargeTemp4:        {type: String}, // 83 guage
        ...
        compWaterTemp:         {type: String}, // 93 guage
        compWaterTempKill:     {type: String}, // 94
        compWaterPress:        {type: String}, // 95 guage
        compWaterPressKill:    {type: String}, // 96
