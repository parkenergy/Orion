...
var workOrderSchema = new mongoose.Schema({
  ...
  unitReadings: {
    ...
    flowMCF:                { type: Number },
    rpm:                    { type: Number },
    dischargeTemp1:         { type: Number },
    dischargeTemp2:         { type: Number },
    hourReading:            { type: Number },
    compressorSerial:       { type: Number },
    engineSerial:           { type: Number },
    engineOilPressure:      { type: Number },
    alternatorOutput:       { type: Number },
    compressorOilPressure:  { type: Number },
    engineJWTemp:           { type: Number },
    engineManifoldVac:      { type: Number }
  },

  emissionsReadings: {
    afrmvTarget:      { type: Number },
    catalystTempPre:  { type: Number },
    catalystTempPost: { type: Number },
    permitNumber:     { type: Number }
  },

  pmChecklist: {
    killSettings: {
      highSuctionKill:        { type: Number },
      highDischargeKill:      { type: Number },
      lowSuctionKill:         { type: Number },
      lowDischargeKill:       { type: Number },
      highDischargeTempKill:  { type: Number }
    },
    engineChecks: {
    ...
    fuelPressureFirstCut:   { type: Number },
    fuelPressureSecondCut:  { type: Number },
    visibleLeaksNotes:      { type: String },
    engineCompression: {
      cylinder1: { type: Number },
      cylinder2: { type: Number },
      cylinder3: { type: Number },
      cylinder4: { type: Number },
      cylinder5: { type: Number },
      cylinder6: { type: Number },
      cylinder7: { type: Number },
      cylinder8: { type: Number }
    }
  },
