...
class WOSync {
    ...
    constructor (Units, Users, WorkOrders, data, newArray) {
        this.Units = Units
        this.Users = Users
     ...
     * Only used on Create but is useflu to keep WO managers
     * page clean
        ...
        return new Promise((resolve, reject) => {
            this.WorkOrders.findById(data.id)
                ...
                .then((doc) => {
                    ...
                    return this.WorkOrders.findByIdAndUpdate(doc._id, doc,
                        {safe: false, new: true})
                               .lean()
                               .exec()
                })
