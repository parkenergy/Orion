...
angular
    ...
    .factory('KillCodes', ['$resource', function ($resource) {
    ...
    .factory('MCUnitDiligenceForms', ['$resource', function ($resource) {
    ...
    .factory('WoUnitInputMatrixes', ['$resource', function ($resource) {
        return $resource('/api/WOUnitInputsMatrix/:id', {id: '@id'})
    }])

    .factory('FrameModels', ['$resource', function ($resource) {
        return $resource('/api/FrameModels/:id', {id: '@id'})
    }])

    .factory('EngineModels', ['$resource', function ($resource) {
        return $resource('/api/EngineModels/:id', {id: '@id'})
    }])
    .factory('WOPMCheck', ['$resource', function ($resource) {
