angular.module('CommonServices').factory('ApiRequestService', [
    '$q',
    '$http',
    'Units',
    'Users',
    ...
    function ($q, $http, Units, Users, ReviewNotes, Customers, CallReports, PartOrders, WorkOrders,
        PaidTimeOffs, Counties, MCUnitDiligenceForms) {
        const ARS = {};
        ARS.http = {
            get: {},
        };
