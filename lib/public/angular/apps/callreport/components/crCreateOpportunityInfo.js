...
function CrCreateOpportunityInfoCtrl (ObjectService) {
  ...
  self.$onInit = function () {
    ...
    // Only populate these fields on load
    self.statusTypeArray = self.statustypes;
    self.appTypeArray = self.applicationtypes;
    self.unitTypeArray = self.unittypes;
