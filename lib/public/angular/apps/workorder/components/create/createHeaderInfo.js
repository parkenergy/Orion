class createHeaderInfo {
    constructor ($scope, $timeout, ObjectService, ApiRequestService) {
...
angular
    ...
    .component('createHeaderInfo', {
        ...
        controller:  ['$scope', '$timeout', 'ObjectService','ApiRequestService', createHeaderInfo],
    })
