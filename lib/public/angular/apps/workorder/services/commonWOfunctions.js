angular.module('WorkOrderApp.Services')
       .factory('CommonWOfunctions', ['ObjectService', function (ObjectService) {
  ...
  // ----------------------------------------------------
    ...
    CommonWOFunctions.clearNoneEngineFrame = function (wo, woInputs) {
        woInputs.forEach((input) => {
            ...
            if (!found) {
                // clear this input
                ObjectService.setObjValue(wo, input.path, '')
            }
        })
        return wo
    }
        ...
        return {
            ...
            laborCodes: {
                ...
                engine:     {
                    ...
                    EICSSensorActuators:   {hours: 0, minutes: 0, text: 'EICS Sensor/Actuators'},
                },
                emissions:  {
                    ...
                    exhaustGasketReplace:    {hours: 0, minutes: 0, text: 'Exhaust Gasket Replace'},
