angular.module('WorkOrderApp.Controllers').controller('WorkOrderReviewCtrl', ['$window',
        ...
        'DateService', 'locations', 'Utils', 'woInputMatrixes', 'frameModels', 'engineModels', function ($window, $http, $q, $scope,
        ...
        $scope.isManual = (part) => {
            if (part.isManual === true) {
                return {backgroundColor: $scope.red}
            }
        }
