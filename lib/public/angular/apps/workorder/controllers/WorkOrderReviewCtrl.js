function WorkOrderReviewCtrlFunc ($window, $http, $q, $scope,
    ...
    parts, DateService, locations, Utils, woInputMatrixes, frameModels, engineModels, states, counties) {
...
angular
    ...
    .controller('WorkOrderReviewCtrl', ['$window',
        ...
        'DateService', 'locations', 'Utils', 'woInputMatrixes', 'frameModels', 'engineModels', 'states', 'counties', WorkOrderReviewCtrlFunc])
