...
.component('areaPmDash', {
    ...
    controller: [
        '$location', '$timeout', 'PmDashService', class AreaPmDashCtrl {
            ...
            $onInit () {
                ...
                this.users.forEach((user) => {
                    ...
                    thisUser.name = user.firstName.concat(' ').concat(
                        user.lastName);
                    if (user.email) {
                ...
                this.activePMStatus = this.PMS.totalPercent(this.displayUsers).toFixed(
                    0);
            }
            // ----------------------------------------------------

            $doCheck () {
                if (this.users[0].hasOwnProperty('unapprovedCount') &&
                    this.init === null) {
                    this.$timeout(() => {
